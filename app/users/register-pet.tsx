...
export default function RegisterPet() {
  ...
  async function onSave() {
    ...
    try {
      ...
      console.debug("PATCH preferences ->", { userId, preferencesPayload });
      ...
      console.debug("PATCH petPreference response", {
        status: resp.status,
        body: respText,
      });
      if (!resp.ok) {
        console.error("Failed to save pet preference", {
          status: resp.status,
          body: respText,
        });
      ...
      router.replace("/users/register-home" as any);
    } catch (err) {
